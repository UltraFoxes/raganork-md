...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '2348163137129-1632403322@g.us',
    ...
    BOT_INFO: process.env.BOT_INFO || 'HITMAN;L06S;0;https://imgur.com/a/WVjPr7X.jpeg;https://chat.whatsapp.com/BlgFAVAC4Cv5NpcQ8CscW8',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "HITMAN",
    BOT_NAME: process.env.BOT_NAME || 'HITMAN',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭UNDEAD KING¹¹ꫂ;HITMAN MD bot;https://imgur.com/a/WVjPr7X.jpeg' : process.env.AUDIO_DATA,
